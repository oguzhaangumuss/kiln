...
export function AdvantageConsole() {
  ...
  const markdown = useMemo(
    ...
    // Stamp regenerates the timestamped report.
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-8">
      ...
      <p className="mt-3 font-sans text-sm leading-6 text-ink/80">
        Three real tasks, both ways: what you can prove, and the attached outputs.
        One is trading (grid), one is security (liquidation). Kiln is a hire desk —
        sample reads the published catalog. No invented minutes, win-rate, or Venus HF.
      </p>
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        ...
        <Link href="/" className="border border-line px-4 py-2 font-mono text-xs uppercase">
          Back to marketplace
        </Link>
      </div>
      {ran ? (
